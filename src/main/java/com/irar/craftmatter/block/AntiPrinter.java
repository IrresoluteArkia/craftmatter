...
public class AntiPrinter extends Block implements ITileEntityProvider{
	public AntiPrinter(Material mat, String name, float hardness, float resistance, int harvest, String tool){
		super(mat);
	...
	public void onBlockPlacedBy(World worldIn, BlockPos pos, IBlockState state, EntityLivingBase placer, ItemStack stack) {
	    if (stack.hasDisplayName()) {
	        ((TilePrinter) worldIn.getTileEntity(pos)).setCustomName(stack.getDisplayName());
	    }
	}
	@Override
	...
	public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer player, EnumHand hand, EnumFacing side, float hitX, float hitY, float hitZ) {
	    if (!world.isRemote) {
	        player.openGui(CraftMatter.instance, GuiHandler.TILE_PRINTER_GUI, world, pos.getX(), pos.getY(), pos.getZ());
	    }
	    return true;
	}
